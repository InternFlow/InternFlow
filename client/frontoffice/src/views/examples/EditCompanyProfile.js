...
import { faChartColumn, faEdit, faEye, faPlus, faTrash } from "@fortawesome/free-solid-svg-icons";
        ...
        <Container>
          <div className="owner">
            ...
            <Form onSubmit={handleSearchSubmit}>
              ...
              <Button color="info" className="mr-2" onClick={handleRefresh}>
                <i className="nc-icon nc-refresh-69"></i>
              </Button>
              <Button color="primary" type="submit" onClick={handleAddOffer}>
              ...
              <Col md="12">
                ...
                <Row className="justify-content-center my-4">
                  {currentItems.map((offer) => (
                    ...
                    <Col xs="12" sm="7" md="4" lg="4" key={offer.id} className="mb-4">
